 ...
 */
#define _MAIN_DUMMY_DRIVERS_2_C_ 
#ifndef _MAIN_DUMMY_DRIVERS_2_C_
...
void main(void)
{
    ...
    sys_log_print_event_from_module(SYS_LOG_INFO, DUMMY_NAME, "Unit test drivers dummy 2");
    sys_log_new_line();
...
#endif /* _MAIN_DUMMY_DRIVERS_2_C_ */
