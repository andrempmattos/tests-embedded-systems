 ...
 */
#define _MAIN_DUMMY_APP_5_C_ 
#ifndef _MAIN_DUMMY_APP_5_C_
...
void main(void)
{
    ...
    sys_log_print_event_from_module(SYS_LOG_INFO, DUMMY_NAME, "Unit test app dummy 5");
    sys_log_new_line();
