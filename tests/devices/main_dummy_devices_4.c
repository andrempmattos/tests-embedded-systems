 ...
 */
#define _MAIN_DUMMY_DEVICES_4_C_ 
#ifndef _MAIN_DUMMY_DEVICES_4_C_
...
void main(void)
{
    ...
    sys_log_print_event_from_module(SYS_LOG_INFO, DUMMY_NAME, "Unit test devices dummy 4");
    sys_log_new_line();
...
#endif /* _MAIN_DUMMY_DEVICES_4_C_ */
