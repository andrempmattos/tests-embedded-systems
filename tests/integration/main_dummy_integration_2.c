 ...
 */
#define _MAIN_DUMMY_INTEGRATION_2_C_ 
#ifndef _MAIN_DUMMY_INTEGRATION_2_C_
...
void main(void)
{
    ...
    sys_log_print_event_from_module(SYS_LOG_INFO, DUMMY_NAME, "Unit test integration dummy 2");
    sys_log_new_line();
...
#endif /* _MAIN_DUMMY_INTEGRATION_2_C_ */
